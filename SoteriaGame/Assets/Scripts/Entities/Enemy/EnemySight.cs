...
//	{
//		if (player.gameObject.tag == "Player" && !this.GetComponent<BasicEnemyController>().GetStunStatus() && GameDirector.instance.GetPlayer().GetPlayerState() != PlayerState.Hidden)
//		{
